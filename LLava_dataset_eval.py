...
OUTPUT_CSV = "yolo_llava_eval_results.csv"
...
def build_prompt(detections_text: str) -> str:
    return f"""USER: <image>
You are a PPE safety inspector.
...
def parse_llava_output(text: str) -> dict:
    compliance = "unknown"
    missing_items = []
...
for idx, image_path in enumerate(image_paths, start=1):
    ...
    prompt = build_prompt(detections_text)
...
print(f"Skipped unparsable LLaVA: {skipped_unparsed}")
